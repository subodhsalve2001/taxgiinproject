const food = require("../../../../models/admin/productPrice/compliance/foodProductPriceModel")
...
exports.AddfoodProduct = async (req, res) => {
    try {
        ...
        const result = await food.create({ title, price, desc })
...
exports.deleteProduct = async (req, res) => {
    try {
        const reult = await food.deleteMany()
        res.json({
